...
maxControl(SG_batchSize=NULL)
try(maxControl(SG_batchSize=-1))
try(maxControl(SG_batchSize=2:3))

maxControl(SG_clip=NULL)
try(maxControl(SG_clip=-1))
try(maxControl(SG_clip=2:3))

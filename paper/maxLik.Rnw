...
instance replacing the distribution mixture with a single component.
Note that this problem cannot be handled by constrained maximization
either, as the mixture parameters are not identified, if the fraction

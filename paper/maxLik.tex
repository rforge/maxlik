...
\code{maxBHHH} does not need a Hessian and
\code{maxSANN} neither needs the gradients nor the Hessian.
If these arguments are specified anyway, they are ignored.
...
\code{"BFGS"}, \code{"NM"}, or \code{"SANN"}.
